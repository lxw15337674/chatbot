...
export function SlashCommandMenu({
  ...
  return (
    <div
      className="absolute bottom-full left-0 right-0 z-50 mb-2 overflow-hidden rounded-xl border border-border/50 bg-card/95 shadow-(--shadow-float) backdrop-blur-xl"
      ref={menuRef}
    >
